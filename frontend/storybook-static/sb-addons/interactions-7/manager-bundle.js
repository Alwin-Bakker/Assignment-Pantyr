      ...
      Qn = (e, t, r, n) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let a of Br(t))
            !Zn.call(e, a) &&
              a !== r &&
              zr(e, a, { get: () => t[a], enumerable: !(n = Jn(t, a)) || n.enumerable });
        return e;
      },
      xe = (e, t, r) => (
        (r = e != null ? Kn(Xn(e)) : {}),
      ...
      ga = (e, t, r, n) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let a of Wr(t))
            !fa.call(e, a) &&
              a !== r &&
              Dr(e, a, { get: () => t[a], enumerable: !(n = pa(t, a)) || n.enumerable });
        return e;
      },
      Ge = (e, t, r) => (
        (r = e != null ? ua(ma(e)) : {}),
                ...
                : (m.min ? '' : _ + r) +
                    (n.indexOf(_) !== -1
                      ? `{${(0, t.printObjectProperties)(
                          c(b)
                            ? Array.from(b).reduce((O, R) => ((O[R.name] = R.value), O), {})
                            : { ...b },
                          m,
                          v,
                          d,
...
`) !== -1 && (I = b.spacingOuter + S + I + b.spacingOuter + m),
                    (I = `{${I}}`)),
                  `${b.spacingInner + m + _.prop.open + O + _.prop.close}=${_.value.open}${I}${
                    _.value.close
                  }`
                );
              })
          ...
          var a = (f, h, b, m, v, d) =>
            f
              .map((y) => h.spacingOuter + b + (typeof y == 'string' ? s(y, h) : d(y, h, b, m, v)))
              .join('');
          e.printChildren = a;
          var s = (f, h) => {
          ...
          function z(g, $, H, X, K, x) {
            ...
            return Te === '[object Arguments]'
              ...
              ? ne
                ? `[${g.constructor.name}]`
                : `${
                    oe || (!$.printBasicPrototype && g.constructor.name === 'Array')
                      ? ''
                      : `${g.constructor.name} `
...
${Te}`,
          ...
          var j = (g) =>
            ...
            V = () =>
              L.reduce((g, $) => ((g[$] = { close: '', open: '' }), g), Object.create(null)),
                  ...
                  if (ue <= P && ae - 1 <= I[ue]) {
                    ...
                    if (
                      ...
                      (E.nCommonFollowing = fe),
                        fe !== 0 && ((E.aCommonFollowing = M), (E.bCommonFollowing = me));
                      let _e = M + fe,
                        we = me + fe;
                      d - 1 === S + O - _e - we
                        ? ((E.aStartFollowing = S), (E.bStartFollowing = O))
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            function O(l, u) {
              ...
              return (
                ...
                typeof A == 'string'
                  ? (A = _(A))
                  : typeof A != 'number' && (A = '['.concat(u.inspect(A, u), ']')),
                (u.truncate -= A.length),
                (N = u.inspect(N, u)),
                ''.concat(A, ': ').concat(N)
              );
...
`,
    ...
    function Bt(e) {
      ...
      if (e)
        if (typeof e == 'object')
          if (Array.isArray(e))
            for (t = 0; t < e.length; t++) e[t] && (r = Bt(e[t])) && (n && (n += ' '), (n += r));
    ...
    var po = {
      ...
      Xr = (e, t) => {
        ...
        for (let r = t - 1; r >= 0; r -= 1)
          if (fo.test(e[r]) && r > 10) return `${e.slice(0, r).replace($r, '')}\u2026`;
        ...
        return q(
          ...
          e.showDiff && e.diff
            ...
            : q(
                ...
                q('br', null),
                e.expected &&
                  q(Ne, null, 'Expected: ', q(yt, { value: e.expected }), q('br', null)),
                ...
                q(
                  ...
                  a?.length > 0 &&
                    q(
                      ...
                      {
                        hasChrome: !1,
                        tooltip: q(Go, { note: `${o ? 'Show' : 'Hide'} interactions` }),
                      },
        ...
        Be(() => {
          r((T) => {
            ...
            return {
              ...T,
              interactions: E,
              interactionsCount: E.filter(({ method: F }) => F !== 'step').length,
            };
          });
        }, [s]);
        let O = nr(
