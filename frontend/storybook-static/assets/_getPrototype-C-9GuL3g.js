import { c as Bu, a as Uu } from './_commonjsHelpers-C4iS2aBk.js';
...
function Tr(u) {
  return u == null ? (u === void 0 ? xr : _r) : ue && ue in Object(u) ? gr(u) : mr(u);
}
var lu = Tr;
function br(u) {
  var e = typeof u;
...
var X = Dt,
  ...
  At = (function () {
    try {
      var u = st(Object, 'defineProperty');
      return u({}, '', {}), u;
    } catch {}
  })(),
  ot = At,
...
function It(u, e) {
  ...
  return (
    (e = e ?? Nt),
    !!e && (r == 'number' || (r != 'symbol' && Pt.test(u))) && u > -1 && u % 1 == 0 && u < e
  );
}
var Pe = It,
  Rt = 9007199254740991;
...
var Ku = Lt,
  ...
  s0 = '[object Uint8ClampedArray]',
  A0 = '[object Uint16Array]',
  o0 = '[object Uint32Array]',
  S = {};
S[r0] = S[t0] = S[a0] = S[n0] = S[i0] = S[D0] = S[s0] = S[A0] = S[o0] = !0;
S[jt] =
  S[Gt] =
  S[u0] =
  S[Kt] =
  ...
  S[Zt] =
    !1;
function F0(u) {
  return Ut(u) && kt(u.length) && !!S[Mt(u)];
}
var C0 = F0;
function l0(u) {
  return function (e) {
...
function en(u, e) {
  var r = this.__data__;
  return (this.size += this.has(u) ? 0 : 1), (r[u] = Za && e === void 0 ? un : e), this;
}
var rn = en,
  tn = ka,
  an = ja,
...
var An = eu,
  ...
  Fn = qu;
function Cn() {
  (this.size = 0), (this.__data__ = { hash: new De(), map: new (Fn || on)(), string: new De() });
}
var ln = Cn;
function cn(u) {
  var e = typeof u;
...
function kn(u, e) {
  ...
  if (r instanceof In) {
    var t = r.__data__;
    if (!Rn || t.length < Mn - 1) return t.push([u, e]), (this.size = ++r.size), this;
...
function vu(u) {
  var e = -1,
    r = u == null ? 0 : u.length;
  for (this.__data__ = new Yn(); ++e < r; ) this.add(u[e]);
}
...
function Fi(u, e, r, t, a, i) {
  ...
  for (i.set(u, e), i.set(e, u); ++x < l; ) {
    ...
    if (m) {
      if (
        !Di(e, function (I, L) {
          if (!si(m, L) && (d === I || a(d, I, r, t, i))) return m.push(L);
        })
      ) {
        F = !1;
        break;
...
function Ri(u, e, r, t, a, i, n) {
  switch (r) {
    ...
    case wi:
      var f = t & gi;
      if ((l || (l = vi), u.size != e.size && !f)) return !1;
      var B = n.get(u);
      if (B) return B == e;
      (t |= mi), n.set(u, e);
...
var aD = tD,
  ...
  nD = 1,
  iD = Object.prototype,
  DD = iD.hasOwnProperty;
function sD(u, e, r, t, a, i) {
  var n = r & nD,
    l = Ce(u),
    f = l.length,
    B = Ce(e),
  ...
  for (var x = f; x--; ) {
    var F = l[x];
    if (!(n ? F in e : DD.call(e, F))) return !1;
  }
  var m = i.get(u),
    d = i.get(e);
...
var OD = Q,
  ...
  hu = '[object Object]',
  MD = Object.prototype,
  ge = MD.hasOwnProperty;
function kD(u, e, r, t, a, i) {
  var n = he(u),
    l = he(e),
    f = n ? ve : Be(u),
    B = l ? ve : Be(e);
  (f = f == de ? hu : f), (B = B == de ? hu : B);
  var T = f == hu,
    x = B == hu,
    F = f == B;
  if (F && ye(u)) {
  ...
  if (F && !T)
    return i || (i = new Pu()), n || RD(u) ? ND(u, e, r, t, a, i) : PD(u, e, f, r, t, a, i);
  if (!(r & LD)) {
  ...
  return F ? (i || (i = new Pu()), ID(u, e, r, t, a, i)) : !1;
}
var UD = kD,
  jD = UD,
  me = cu;
...
function WD(u, e, r, t) {
  ...
  for (; ++a < i; ) {
    ...
    var f = l[0],
      ...
      T = l[1];
    if (n && l[2]) {
      if (B === void 0 && !(f in u)) return !1;
    } else {
      var x = new GD();
      if (t) var F = t(B, T, f, u, e, x);
      if (!(F === void 0 ? KD(T, B, HD | qD, t, x) : F)) return !1;
    }
  }
  return !0;
}
...
var ns = as,
  ...
  ss = '[object Symbol]';
function As(u) {
  return typeof u == 'symbol' || (Ds(u) && is(u) == ss);
}
var zu = As,
  os = W,
  Fs = zu,
...
function cs(u, e) {
  if (os(u)) return !1;
  var r = typeof u;
  return r == 'number' || r == 'symbol' || r == 'boolean' || u == null || Fs(u)
    ? !0
    : ls.test(u) || !Cs.test(u) || (e != null && u in Object(e));
}
var Vu = cs,
  qe = Wu,
  Es = 'Expected a function';
function Ju(u, e) {
  if (typeof u != 'function' || (e != null && typeof e != 'function')) throw new TypeError(Es);
  var r = function () {
    var t = arguments,
...
var fs = Ju,
  ...
  Bs = 500;
function hs(u) {
  var e = ps(u, function (t) {
      return r.size === Bs && r.clear(), t;
    }),
    r = e.cache;
  return e;
}
var ys = hs,
  ...
  ms = ds(function (u) {
    ...
    return (
      ...
      u.replace(vs, function (r, t, a, i) {
        e.push(a ? i.replace(gs, '$1') : t || r);
      }),
      e
    );
  }),
...
function We(u) {
  ...
  if (Ss(u)) return bs(u, We) + '';
  if ($s(u)) return Te ? Te.call(u) : '';
  var e = u + '';
...
var Ps = Ns,
  ...
  Ms = Ps;
function ks(u, e) {
  return Is(u) ? u : Rs(u, e) ? [u] : Ls(Ms(u));
}
var ze = ks,
  Us = zu;
function js(u) {
  if (typeof u == 'string' || Us(u)) return u;
  var e = u + '';
  return e == '0' && 1 / u == -1 / 0 ? '-0' : e;
}
var bu = js,
...
function Hs(u, e) {
  e = Gs(e, u);
  for (var r = 0, t = e.length; u != null && r < t; ) u = u[Ks(e[r++])];
  return r && r == t ? u : void 0;
}
var Ve = Hs,
  qs = Ve;
function Ws(u, e, r) {
  var t = u == null ? void 0 : qs(u, e);
  return t === void 0 ? r : t;
}
var zs = Ws;
function Vs(u, e) {
...
function rA(u, e, r) {
  ...
  return i || ++t != a
    ? i
    : ((a = u == null ? 0 : u.length), !!a && uA(a) && Zs(n, a) && (Ys(u) || Xs(u)));
}
var tA = rA,
  aA = Js,
  nA = tA;
function iA(u, e) {
  return u != null && nA(u, e, aA);
}
var DA = iA,
  sA = Ge,
  AA = zs,
...
function pA(u, e) {
  return FA(u) && CA(e)
    ...
    : function (r) {
        var t = AA(r, u);
        return t === void 0 && t === e ? oA(r, u) : sA(e, t, EA | fA);
      };
}
var BA = pA;
function hA(u) {
...
var WA = Ze.exports;
(function () {
  (ou.ast = qA), (ou.code = Ye), (ou.keyword = WA);
})();
var su = {},
  Y = {};
const zA = '3.0.0',
...
(function () {
  ...
  (Y.throwError = r), (Y.assert = QA);
})();
(function () {
  var u, e, r, t, a, i, n, l, f, B, T, x;
  (f = ou),
    (B = Y),
    (u = {
  ...
  function m(D, s, y, o) {
    (this._previous = D), (this._index = s), (this._token = y), (this._value = o);
  }
  ...
  function d(D, s) {
    return x && (D.range = [s[0] + T, s[1] + T]), D;
  }
  function c() {
    var D = r.charAt(a);
    return (a += 1), D;
  ...
  function E(D) {
    var s,
      ...
      o,
      A = 0;
    for (y = D === 'u' ? 4 : 2, s = 0; s < y; ++s)
      if (a < t && f.code.isHexDigit(r.charCodeAt(a)))
  ...
  function I() {
    var D = '',
      ...
      A,
      h;
    for (s = r.charAt(a), ++a; a < t; )
      if (((y = c()), y === s)) {
        s = '';
        break;
      } else if (y === '\\')
        if (((y = c()), f.code.isLineTerminator(y.charCodeAt(0))))
...
`;
            ...
            case 'v':
              ...
              break;
            default:
              f.code.isOctalDigit(y.charCodeAt(0))
                ? ((o = '01234567'.indexOf(y)),
                  a < t &&
                    f.code.isOctalDigit(r.charCodeAt(a)) &&
        ...
        if (f.code.isLineTerminator(y.charCodeAt(0))) break;
        D += y;
      }
    return s !== '' && B.throwError('unexpected quote'), (l = D), e.STRING;
  }
  function L() {
    var D, s;
    if (((D = ''), (s = r.charCodeAt(a)), s !== 46)) {
      if (((D = c()), (s = r.charCodeAt(a)), D === '0')) {
        if (s === 120 || s === 88) {
          for (D += c(); a < t && ((s = r.charCodeAt(a)), !!f.code.isHexDigit(s)); ) D += c();
          return (
            D.length <= 2 && B.throwError('unexpected token'),
            a < t &&
              ((s = r.charCodeAt(a)),
              f.code.isIdentifierStartES5(s) && B.throwError('unexpected token')),
            (l = parseInt(D, 16)),
            e.NUMBER
          );
        }
        if (f.code.isOctalDigit(s)) {
          for (D += c(); a < t && ((s = r.charCodeAt(a)), !!f.code.isOctalDigit(s)); ) D += c();
          return (
            a < t &&
              ((s = r.charCodeAt(a)),
              (f.code.isIdentifierStartES5(s) || f.code.isDecimalDigit(s)) &&
                B.throwError('unexpected token')),
            (l = parseInt(D, 8)),
            e.NUMBER
          );
        }
        f.code.isDecimalDigit(s) && B.throwError('unexpected token');
      }
      for (; a < t && ((s = r.charCodeAt(a)), !!f.code.isDecimalDigit(s)); ) D += c();
    }
    if (s === 46)
      for (D += c(); a < t && ((s = r.charCodeAt(a)), !!f.code.isDecimalDigit(s)); ) D += c();
    if (s === 101 || s === 69)
      if (
        ((D += c()),
        (s = r.charCodeAt(a)),
        (s === 43 || s === 45) && (D += c()),
        (s = r.charCodeAt(a)),
        f.code.isDecimalDigit(s))
      )
        for (D += c(); a < t && ((s = r.charCodeAt(a)), !!f.code.isDecimalDigit(s)); ) D += c();
      else B.throwError('unexpected token');
    return (
      a < t &&
        ((s = r.charCodeAt(a)), f.code.isIdentifierStartES5(s) && B.throwError('unexpected token')),
      (l = parseFloat(D)),
      e.NUMBER
    );
  }
  function z() {
    ...
    for (l = c(); a < t && F(r.charCodeAt(a)); ) {
      if (((D = r.charCodeAt(a)), D === 46)) {
        if (a + 1 >= t) return e.ILLEGAL;
        if (((s = r.charCodeAt(a + 1)), s === 60)) break;
      }
      l += c();
    }
    return e.NAME;
  ...
  function M() {
    var D;
    for (i = a; a < t && f.code.isWhiteSpace(r.charCodeAt(a)); ) c();
    if (a >= t) return (n = e.EOF), n;
    switch (((D = r.charCodeAt(a)), D)) {
      case 39:
      case 34:
        return (n = I()), n;
      case 58:
      ...
      case 46:
        if (a + 1 < t) {
          if (((D = r.charCodeAt(a + 1)), D === 60)) return c(), c(), (n = e.DOT_LT), n;
          if (D === 46 && a + 2 < t && r.charCodeAt(a + 2) === 46)
            return c(), c(), c(), (n = e.REST), n;
          if (f.code.isDecimalDigit(D)) return (n = L()), n;
        }
      ...
      case 45:
        return (n = L()), n;
      default:
        return f.code.isDecimalDigit(D) ? ((n = L()), n) : (B.assert(F(D)), (n = z()), n);
    }
  }
  function _(D, s) {
  ...
  function k() {
    var D,
      s = a - 1;
    if ((_(e.LPAREN, 'UnionType should start with ('), (D = []), n !== e.RPAREN))
      for (; D.push(U()), n !== e.RPAREN; ) C(e.PIPE);
    return (
      _(e.RPAREN, 'UnionType should end with )'), d({ type: u.UnionType, elements: D }, [s, i])
    );
  }
  function p() {
    var D,
      s = a - 1,
      y;
    for (_(e.LBRACK, 'ArrayType should start with ['), D = []; n !== e.RBRACK; ) {
      if (n === e.REST) {
        (y = a - 3), _(e.REST), D.push(d({ type: u.RestType, expression: U() }, [y, i]));
        break;
      } else D.push(U());
      n !== e.RBRACK && C(e.COMMA);
    }
    return C(e.RBRACK), d({ type: u.ArrayType, elements: D }, [s, i]);
  }
  function j() {
    var D = l;
    if (n === e.NAME || n === e.STRING) return M(), D;
    if (n === e.NUMBER) return _(e.NUMBER), String(D);
    B.throwError('unexpected token');
  }
  function G() {
    var D,
    ...
    return (
      (D = j()),
      n === e.COLON
        ? (_(e.COLON), d({ type: u.FieldType, key: D, value: U() }, [s, i]))
        : d({ type: u.FieldType, key: D, value: null }, [s, i])
    );
  }
  function g() {
    var D,
      s = a - 1,
      y;
    if ((_(e.LBRACE, 'RecordType should start with {'), (D = []), n === e.COMMA)) _(e.COMMA);
    else for (; n !== e.RBRACE; ) D.push(G()), n !== e.RBRACE && C(e.COMMA);
    return (y = a), C(e.RBRACE), d({ type: u.RecordType, fields: D }, [s, y]);
  }
  function nu() {
    var D = l,
      s = a - D.length;
    return (
      ...
      n === e.COLON &&
        ...
        (_(e.COLON), (D += ':' + l), C(e.NAME)),
      d({ type: u.NameExpression, name: D }, [s, i])
    );
  }
  function Eu() {
    var D = [];
    for (D.push(K()); n === e.COMMA; ) _(e.COMMA), D.push(K());
    return D;
  }
  function V() {
    var D,
    ...
    return (
      ...
      n === e.DOT_LT || n === e.LT
        ? (M(),
          (s = Eu()),
          C(e.GT),
          d({ type: u.TypeApplication, expression: D, applications: s }, [y, i]))
        : D
    );
  }
  function fu() {
  ...
  function $() {
    for (var D = [], s = !1, y, o = !1, A, h = a - 3, v; n !== e.RPAREN; )
      n === e.REST && (_(e.REST), (o = !0)),
        ...
        n === e.EQUAL
          ? (_(e.EQUAL), (y = d({ type: u.OptionalType, expression: y }, [A, i])), (s = !0))
          : s && B.throwError('unexpected token'),
  ...
  function iu() {
    ...
    switch (n) {
      ...
      case e.LBRACE:
        return g();
      case e.NAME:
        if (((s = a - l.length), l === 'null'))
          return _(e.NAME), d({ type: u.NullLiteral }, [s, i]);
        if (l === 'undefined') return _(e.NAME), d({ type: u.UndefinedLiteral }, [s, i]);
        if (l === 'true' || l === 'false')
          return _(e.NAME), d({ type: u.BooleanLiteralType, value: l === 'true' }, [s, i]);
        if (((D = m.save()), l === 'function'))
          try {
            return $u();
          } catch {
            D.restore();
  ...
  function U() {
    ...
    return n === e.QUESTION
      ? ((s = a - 1),
        ...
        n === e.RBRACK ||
        n === e.GT
          ? d({ type: u.NullableLiteral }, [s, i])
          : d({ type: u.NullableType, expression: iu(), prefix: !0 }, [s, i]))
      : n === e.BANG
      ? ((s = a - 1),
        _(e.BANG),
        d({ type: u.NonNullableType, expression: iu(), prefix: !0 }, [s, i]))
      : ((s = i),
        (D = iu()),
        n === e.BANG
          ? (_(e.BANG), d({ type: u.NonNullableType, expression: D, prefix: !1 }, [s, i]))
          : n === e.QUESTION
          ? (_(e.QUESTION), d({ type: u.NullableType, expression: D, prefix: !1 }, [s, i]))
          : n === e.LBRACK
          ? (_(e.LBRACK),
            ...
            d(
              {
                ...
                expression: d({ type: u.NameExpression, name: 'Array' }, [s, i]),
                applications: [D],
              },
              [s, i],
            ))
  ...
  function K() {
    var D, s;
    if (((D = U()), n !== e.PIPE)) return D;
    for (s = [D], _(e.PIPE); s.push(U()), n === e.PIPE; ) _(e.PIPE);
    return d({ type: u.UnionType, elements: s }, [0, a]);
  }
  function J() {
    var D;
    return n === e.REST
      ...
      : ((D = K()),
        n === e.EQUAL ? (_(e.EQUAL), d({ type: u.OptionalType, expression: D }, [0, a])) : D);
  }
  function pu(D, s) {
    var y;
    return (
  ...
  function w(D, s, y) {
    ...
    switch (D.type) {
      ...
      case u.VoidLiteral:
        ...
        break;
      case u.UnionType:
        for (y ? (o = '') : (o = '('), A = 0, h = D.elements.length; A < h; ++A)
          (o += w(D.elements[A], s)), A + 1 !== h && (o += s ? '|' : ' | ');
        y || (o += ')');
        break;
      case u.ArrayType:
        for (o = '[', A = 0, h = D.elements.length; A < h; ++A)
          (o += w(D.elements[A], s)), A + 1 !== h && (o += s ? ',' : ', ');
        o += ']';
        break;
      case u.RecordType:
        for (o = '{', A = 0, h = D.fields.length; A < h; ++A)
          (o += w(D.fields[A], s)), A + 1 !== h && (o += s ? ',' : ', ');
        o += '}';
        break;
      case u.FieldType:
        D.value ? (o = D.key + (s ? ':' : ': ') + w(D.value, s)) : (o = D.key);
        break;
      case u.FunctionType:
        for (
          o = s ? 'function(' : 'function (',
            D.this &&
              (D.new ? (o += s ? 'new:' : 'new: ') : (o += s ? 'this:' : 'this: '),
              (o += w(D.this, s)),
              D.params.length !== 0 && (o += s ? ',' : ', ')),
            A = 0,
            h = D.params.length;
          A < h;
          ++A
        )
          (o += w(D.params[A], s)), A + 1 !== h && (o += s ? ',' : ', ');
        (o += ')'), D.result && (o += (s ? ':' : ': ') + w(D.result, s));
        break;
      case u.ParameterType:
        o = D.name + (s ? ':' : ': ') + w(D.expression, s);
        break;
      case u.RestType:
        (o = '...'), D.expression && (o += w(D.expression, s));
        break;
      case u.NonNullableType:
        D.prefix ? (o = '!' + w(D.expression, s)) : (o = w(D.expression, s) + '!');
        break;
      case u.OptionalType:
        o = w(D.expression, s) + '=';
        break;
      ...
      case u.TypeApplication:
        for (o = w(D.expression, s) + '.<', A = 0, h = D.applications.length; A < h; ++A)
          (o += w(D.applications[A], s)), A + 1 !== h && (o += s ? ',' : ', ');
        o += '>';
        break;
  ...
  function O(D, s) {
    return s == null && (s = {}), w(D, s.compact, s.topLevel);
  }
  (su.parseType = pu), (su.parseParamType = wu), (su.stringify = O), (su.Syntax = u);
})();
(function (u) {
  (function () {
    var e, r, t, a, i;
    ...
    function l(C) {
      var k = {},
        p;
      for (p in C) C.hasOwnProperty(p) && (k[p] = C[p]);
      return k;
    }
    function f(C) {
...
\u2028\u2029])`;
    ...
    function _(C, k) {
      for (var p = C.replace(/^\/\*\*?/, ''), j = 0, G = new RegExp(z, 'g'), g; (g = G.exec(p)); )
        if (((j += g[1].length), g.index + g[0].length > k + j)) return k + j + C.length - p.length;
      return C.replace(/\*\/$/, '').replace(/\s*$/, '').length;
    }
    (function (C) {
      var k, p, j, G, g, nu, Eu, V, fu;
      function $() {
        var o = g.charCodeAt(p);
        return (
          (p += 1),
          a.code.isLineTerminator(o) && !(o === 13 && g.charCodeAt(p) === 10) && (j += 1),
          String.fromCharCode(o)
        );
      }
      function $u() {
        var o = '';
        for ($(); p < G && f(g.charCodeAt(p)); ) o += $();
        return o;
      }
      function iu() {
        var o,
      ...
      function U(o, A, h) {
        for (var v, N, b, R, q = !1; p < A; )
          if (((v = g.charCodeAt(p)), a.code.isWhiteSpace(v))) $();
          else if (v === 123) {
            $();
            break;
          } else {
        ...
        if (q) return null;
        for (N = 1, b = ''; p < A; )
          if (((v = g.charCodeAt(p)), a.code.isLineTerminator(v))) $();
          else {
            if (v === 125) {
              if (((N -= 1), N === 0)) {
                $();
      ...
      function K(o) {
        var A;
        if (!a.code.isIdentifierStartES5(g.charCodeAt(p)) && !g[p].match(/[0-9]/)) return null;
        for (A = $(); p < o && a.code.isIdentifierPartES5(g.charCodeAt(p)); ) A += $();
        return A;
      }
      function J(o) {
        for (
          ;
          p < o &&
          (a.code.isWhiteSpace(g.charCodeAt(p)) || a.code.isLineTerminator(g.charCodeAt(p)));
      ...
      function pu(o, A, h) {
        var v = '',
          N,
          b;
        if ((J(o), p >= o)) return null;
        if (g.charCodeAt(p) === 91)
          if (A) (N = !0), (v = $());
          else return null;
        if (((v += K(o)), h))
          for (
            g.charCodeAt(p) === 58 &&
              ...
              ((v += $()), (v += K(o))),
              g.charCodeAt(p) === 91 && g.charCodeAt(p + 1) === 93 && ((v += $()), (v += $()));
            g.charCodeAt(p) === 46 ||
            g.charCodeAt(p) === 47 ||
            g.charCodeAt(p) === 35 ||
            g.charCodeAt(p) === 45 ||
            ...
            (v += $()), (v += K(o));
        if (N) {
          if ((J(o), g.charCodeAt(p) === 61)) {
            (v += $()), J(o);
            for (var R, q = 1; p < o; ) {
              if (
                ((R = g.charCodeAt(p)),
                a.code.isWhiteSpace(R) && (b || (J(o), (R = g.charCodeAt(p)))),
                R === 39 && (b ? b === "'" && (b = '') : (b = "'")),
                R === 34 && (b ? b === '"' && (b = '') : (b = '"')),
                R === 91)
              )
          ...
          if ((J(o), p >= o || g.charCodeAt(p) !== 93)) return null;
          v += $();
        }
        return v;
      }
      function wu() {
        for (; p < G && g.charCodeAt(p) !== 64; ) $();
        return p >= G ? !1 : (r.assert(g.charCodeAt(p) === 64), !0);
      }
      function w(o) {
      ...
      (O.prototype.addError = function (A) {
        ...
        (O.prototype.parseName = function () {
          ...
          if (m(this._title))
            if (
              ((this._tag.name = pu(this._last, V && c(this._title), d(this._title))),
              this._tag.name)
            )
              (A = this._tag.name),
                A.charAt(0) === '[' &&
      ...
      function D(o) {
        var A, h, v;
        if (!wu()) return null;
        for (A = $u(), h = new O(o, A), v = h.parse(); p < h._last; ) $();
        return v;
      }
      function s(o) {
        var A = '',
          h,
          v;
        for (v = !0; p < G && ((h = g.charCodeAt(p)), !(v && h === 64)); )
...
var ur = /^['"]|['"]$/g,
  ...
  er = (u) => {
    let e = ZA(u);
    return u1(u) || Number.isNaN(Number(e)) ? e : Number(e);
  },
  e1 = (u) => {
    switch (u.type) {
      case 'function':
  ...
  Cu = (u) => {
    ...
    switch ((typeof r < 'u' && (t.raw = r), u.name)) {
      ...
      case 'signature':
        return { ...t, ...a1(u) };
      case 'union':
        return u.elements.every(r1)
          ? { ...t, name: 'enum', value: u.elements.map(t1) }
  ...
  Au = (u) => {
    ...
    switch ((typeof r < 'u' && (i.raw = r), e)) {
      ...
      default: {
        ...
        let l = a ? `${e}(${a})` : e,
          f = n1.test(e) ? 'function' : 'other';
        return { ...i, name: f, value: l };
      }
    }
  },
  Qu = (u) => {
...
function F1(u) {
  return rr(u) && s1(u.__docgenInfo.description);
}
function C1(u) {
...
function l1(u, e) {
  let r;
  try {
    r = XA.parse(u, { tags: e, sloppy: !0 });
  } catch (t) {
    throw (console.error(t), new Error('Cannot parse JSDoc tags.'));
  }
  return r;
}
var c1 = { tags: ['param', 'arg', 'argument', 'returns', 'ignore', 'deprecated'] },
  E1 = (u, e = c1) => {
    if (!C1(u)) return { includesJsDoc: !1, ignore: !1 };
    let r = l1(u, e.tags),
      t = f1(r);
    return t.ignore
...
function d1({ name: u, raw: e, elements: r }) {
  return r != null ? P(r.map(ar).join(' | ')) : e != null ? P(e.replace(/^\|\s*/, '')) : P(u);
}
function v1({ type: u, raw: e }) {
  return e != null ? P(e) : P(u);
}
function g1({ type: u, raw: e }) {
  return e != null ? (tr(e) ? P(u, e) : P(e)) : P(u);
}
function m1(u) {
  let { type: e } = u;
  return e === 'object' ? g1(u) : v1(u);
}
function _1({ name: u, raw: e }) {
  return e != null ? (tr(e) ? P(u, e) : P(e)) : P(u);
}
function x1(u) {
...
function T1(u, e) {
  if (u != null) {
    let { value: r } = u;
    if (!Xu(r)) return y1(r) ? P(e.name, r) : P(r);
  }
  return null;
}
var b1 = (u, e) => {
  let { flowType: r, description: t, required: a, defaultValue: i } = e;
  return { name: u, type: x1(r), required: a, description: t, defaultValue: T1(i, r) };
};
function S1({ tsType: u, required: e }) {
  if (u == null) return null;
  let r = u.name;
  return (
...
var w1 = (u, e) => {
  ...
  return { name: u, type: S1(e), required: t, description: r, defaultValue: $1(e) };
};
function O1(u) {
...
function I1(u, e) {
  if (u != null) {
    let { value: r } = u;
    if (!Xu(r)) return N1(u) && P1(e) ? P(JSON.stringify(r)) : P(r);
  }
  return null;
}
function nr(u, e, r) {
  let { description: t, required: a, defaultValue: i } = r;
  return { name: u, type: O1(e), required: a, description: t, defaultValue: I1(i, e) };
}
function Su(u, e) {
  var r;
  if (e.includesJsDoc) {
...
var R1 = (u, e, r) => {
  ...
  j1 = (u) => {
    ...
    return e
      .map((a) => {
        let i = u[a];
        return i != null ? sr(a, i, r, t) : null;
      })
      .filter(Boolean);
  },
  V1 = (u, e) => {
    let r = o1(u, e);
    return A1(r) ? (Array.isArray(r) ? U1(r) : j1(r)) : [];
  };
function sr(u, e, r, t) {
  let a = E1(e.description);
...
var Q1 = (u) => {
  ...
  G1 = 'storybook/docs',
  X1 = `${G1}/snippet-rendered`,
  K1 = ((u) => ((u.AUTO = 'auto'), (u.CODE = 'code'), (u.DYNAMIC = 'dynamic'), u))(K1 || {}),
  H1 = Re,
  q1 = H1(Object.getPrototypeOf, Object),
  Y1 = q1;
export {
  P as A,
  Q1 as B,
