...
export default function Button({
  ...
  const base =
    'px-4 py-2 rounded-md font-medium inline-flex items-center gap-2 justify-center transition-colors';
  let styles = '';
  if (variant === 'primary') styles = `${base} bg-p-blue text-white hover:bg-p-dark`;
  else if (variant === 'secondary')
    styles = `${base} bg-p-overlay text-p-dark border border-p-green hover:bg-p-green/30`;
