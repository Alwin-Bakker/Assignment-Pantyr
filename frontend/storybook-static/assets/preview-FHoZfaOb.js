...
const P = typeof crypto < 'u' && crypto.randomUUID && crypto.randomUUID.bind(crypto),
  h = { randomUUID: P };
function S(t, e, r) {
  if (h.randomUUID && !t) return h.randomUUID();
  t = t || {};
...
function p(t, e = {}) {
  let r = { ...x, ...e },
    n = function (...E) {
      ...
      if (e.implicit) {
        let _ =
          (u = '__STORYBOOK_PREVIEW__' in g ? g.__STORYBOOK_PREVIEW__ : void 0) == null
            ? void 0
            : u.storyRenders.find((a) => a.phase === 'playing' || a.phase === 'rendering');
        if (_) {
          let a = !(
              (l = window == null ? void 0 : window.FEATURES) != null &&
              l.disallowImplicitActionsInRenderV8
            ),
            m = new W({ phase: _.phase, name: t, deprecated: a });
          if (a) console.warn(m);
          else throw m;
        }
      }
      let o = U.getChannel(),
        ...
        T = {
          ...
          count: 0,
          data: { name: t, args: O },
          options: { ...r, maxDepth: c + (r.depth || 3), allowFunction: r.allowFunction || !1 },
        };
      o.emit(w, T);
    };
...
var I = (t, e) => typeof e[t] > 'u' && !(t in e),
  L = (t) => {
    ...
    if (!E || E.disable || !E.argTypesRegex || !r) return {};
    let o = new RegExp(E.argTypesRegex);
    return Object.entries(r)
      .filter(([s]) => !!o.test(s))
      .reduce((s, [c, d]) => (I(c, e) && (s[c] = p(c, { implicit: !0, id: n })), s), {});
  },
  v = (t) => {
    let {
      initialArgs: e,
    ...
    return (n != null && n.disable) || !r
      ...
      : Object.entries(r)
          .filter(([E, o]) => !!o.action)
          .reduce(
            (E, [o, s]) => (I(o, e) && (E[o] = p(typeof s.action == 'string' ? s.action : o)), E),
            {},
          );
  },
  F = [v, L],
  B = (t) => {
    ...
    (r != null && r.disable) ||
      Object.entries(e)
        ...
        .forEach(([n, E]) => {
          let o = E.getMockImplementation();
          if (
            (o == null ? void 0 : o._actionAttached) !== !0 &&
            (o == null ? void 0 : o.isAction) !== !0
          ) {
            let s = (...c) => (p(n)(...c), o == null ? void 0 : o(...c));
